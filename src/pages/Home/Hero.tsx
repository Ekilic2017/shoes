const Hero = () => {
    return (
      <div className="relative mt-6 lg:mt-[80px] flex justify-center">
        <div className="absolute text-white top-1/2 transform -translate-y-1/2 ps-4 md:ps-6 lg:ps-8 xl:ps-10">
          ...
          <p className="text-[10px] sm:text-[14px] lg:text-[18px] xl:text-[20px] text-gray font-open font-regular max-w-[50%]">
